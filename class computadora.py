class computadora:
    def __init__(self, id, marca, modelo, procesador, ram):
        self.__id = id
        self.__marca = marca
    ...
    def set_ram(self, ram):
        if ram > 0:
            self.__ram = ram
    #metodo 1 aumentar ram
    def aumentar_ram(self, cantidad):
        if cantidad > 0:
            self.__ram += cantidad
    #metodo 2 metodo de rendimeinto
...
print(compu1.mostrar_informacion())
